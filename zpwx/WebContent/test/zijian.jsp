...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/weui.css" />
<link rel="stylesheet"
				...
				<div class="page__bd" style="height: 90%;">
					<div class="weui-tab">
						...
						<div class="weui-tabbar">
							<a href="##" id="default"
								url="${pageContext.request.contextPath}/wx/wx_main.jsp"
								class="weui-tabbar__item weui-bar__item_on"> <span
								style="display: inline-block; position: relative;"> <img
									src="${pageContext.request.contextPath}/images/icon_tabbar.png"
									alt="" class="weui-tabbar__icon"> <span
									class="weui-badge"
									style="position: absolute; top: -2px; right: -13px;">8</span>
							</span>
								<p class="weui-tabbar__label">微信</p>
							</a> <a url="${pageContext.request.contextPath}/wx/adressList.jsp"
								href="##" class="weui-tabbar__item"> <img
								src="${pageContext.request.contextPath}/images/icon_tabbar.png"
								alt="" class="weui-tabbar__icon">
								<p class="weui-tabbar__label">通讯录</p>
							</a> <a href="##" url="${pageContext.request.contextPath}/wx/found.jsp" class="weui-tabbar__item"> <span
								style="display: inline-block; position: relative;"> <img
									src="${pageContext.request.contextPath}/images/icon_tabbar.png"
									alt="" class="weui-tabbar__icon"> <span
							...
							</a> <a href="##" url="${pageContext.request.contextPath}/myinfo.jsp" class="weui-tabbar__item"> <img
								src="${pageContext.request.contextPath}/images/icon_tabbar.png"
								alt="" class="weui-tabbar__icon">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jweixin-1.0.0.js"></script>
